--! IFF Rejected Invoice (Shipment Level)
-- > Notes
...
FILTER_CTE AS
  (    
   ...
   -- , SUM(CASE WHEN INV.ATTRIBUTE2 IN ( 'REJECTED_OPERATIONS', 'REJECTED_CARRIER', 'ARCHIVED' ) THEN ISCTE.SHIPMENT_COST END)                                                                             APPORTIONED_OCEAN_FREIGHT
    ...
    , INV.ATTRIBUTE_DATE1                                          UPDATE_DATE                                                                                                                         
    FROM 
      INV_SHIP_CTE                                                 ISCTE
    , GLOGOWNER.INVOICE                                            INV
    WHERE   
